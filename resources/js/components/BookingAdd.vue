...
export default {
    ...
    computed: {
        ...mapState({
            ...
            time_work: (state) => state.time_work,
            time_work_text: (state) => state.time_work_text,
            date_booking: (state) => state.date_booking,
            tableId_employmentId: (state) => state.tableId_employmentId,
            busy_time: (state) => state.busy_time,
            free_time: (state) => state.free_time,
            recommended_time: (state) => state.recommended_time,
